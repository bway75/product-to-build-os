...
- Translate and validate technical state, risks, ambiguity, and tradeoffs for Brian.
- Relay only clearly decided Brian intent into executable instructions.
- Observe the relevant cluster buses; write only on the cluster bus where a traceable decision applies.
...
- Escalate ambiguous intent or any new decision to Brian.
- Escalate corpus-side technical or infrastructure ambiguity to Kade and PM-side scope ambiguity to Athena.
